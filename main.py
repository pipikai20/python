    ...
    for i in data["data"]:
        ...
        try:  # 去除广告推广内容的报错
            if item["article_id"] and len(dataSet) < num:
                ...
                dic["view_count"] = item["article_info"]["view_count"]
                dic["collect_count"] = item["article_info"]["collect_count"]
                dic["comment_count"] = item["article_info"]["comment_count"]
                dic["avatar"] = item["author_user_info"]["avatar_large"]
                dic["category"]= item["category"]["category_name"]
                dic["content"] = content
                dic["tags"]=[item["tags"][0]["tag_name"],item["tags"][1]["tag_name"],item["tags"][2]["tag_name"]]
                    # dic["tags1"]=item["tags"][0]["tag_name"]
                    # dic["tags2"]=item["tags"][1]["tag_name"]
                    # dic["tags3"]=item["tags"][2]["tag_name"]
                dataList.append(dic)
